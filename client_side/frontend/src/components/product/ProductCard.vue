  ...
  >
    ...
    <div class="relative h-64 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div class="absolute top-3 left-3 flex gap-2 z-10">
        ...
        <span v-if="product.current_stock <= 10 && product.current_stock > 0" class="bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs font-bold px-2.5 py-1 rounded-full shadow-lg animate-pulse">
          🔥 Low Stock
        </span>
